          ...
          <div className="flex items-center h-full justify-between">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex items-center space-x-4">
                ...
                <Link href="/horaires" className="text-white hover:text-[var(--color-muted)] px-4 py-2.5 rounded-md transition-colors text-lg font-medium">
                🕌 Horaires
                </Link>
            ...
            <div className="hidden md:block ml-6">
              {isLoggedIn ? (
                <div className="relative">
                  ...
                  {showDropdown && (
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-xl py-1.5 z-20 border border-gray-100 dropdown-container">
