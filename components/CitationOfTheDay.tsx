  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 sm:p-8">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-[var(--color-accent)]/20 px-3 py-1 text-xs font-semibold text-gray-900 dark:text-white">
          <svg
        ...
        <blockquote className="text-lg sm:text-xl leading-relaxed text-gray-900 dark:text-white drop-shadow">
          « {quote.text} »
        </blockquote>

        <div className="mt-4 flex flex-wrap items-center gap-2 text-sm text-gray-800 dark:text-gray-200">
          <span className="rounded-md bg-[var(--color-background)]/40 px-2 py-0.5 font-medium text-gray-900 dark:text-white">
            {quote.source}
          </span>
          {quote.reference ? (
            <span className="text-gray-700 dark:text-gray-300">• {quote.reference}</span>
          ) : null}
        </div>
      </div>
    </section>
